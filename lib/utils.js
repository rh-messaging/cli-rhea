...
class Utils {
    ...
    * @memberof Utils
    */
    static printMessage(message, options) {
        ...
        if(options.logMsgs === 'body') {
            ...
            printFunction(Formatter.formatAsUpstream(message, options.contentHashed));
        }else if (options.logMsgs === 'interop') {
            printFunction(Formatter.formatAsInteropDict(message, options.contentHashed));
        }else if (options.logMsgs === 'json') {
            printFunction(Formatter.formatAsJson(message, options.contentHashed));
        }
    }
    ...
    */
    static setUpClientLogging(logLevel) {
        ...
        } else if (logLevel.toUpperCase() === 'ALL') {
            // proton: Log all.
