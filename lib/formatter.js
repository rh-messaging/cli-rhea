...
class Formatter {
     ...
     * @memberof formatter
     */
    static renameKeysInDictInterop(dict) {
        const workDict = {};
        //amqp header
     ...
     * @memberof formatter
     */
    static renameKeysInDictStandard(dict) {
     ...
     * @memberof formatter
     */
    static formatAsDict(message) {
        return Formatter.replaceWithPythonType(JSON.stringify(Formatter.renameKeysInDictStandard(message), Replacer));
    }
     ...
     * @memberof formatter
     */
    static formatAsInteropDict(message) {
        return Formatter.replaceWithPythonType(JSON.stringify(Formatter.renameKeysInDictInterop(message), Replacer));
    }
     ...
     * @memberof formatter
     */
    static formatAsJson(message) {
        return JSON.stringify(Formatter.renameKeysInDictInterop(message), Replacer);
    }
